...
/**
 * Executes a subprocess and handles the worker protocol.
 * This is a pure process.spawn wrapper with protocol handling.
 */
export async function executeSubprocess(options: ExecuteOptions): Promise<any> {
